"""
6.1.24  द्रवमूर्तिस्पर्शयोः श्यः  —  VIDHI
...
_GATE_KEY: str = "6_1_24_dravamUrti_24"


def cond(state: State) -> bool:
    return samhita_gate_eligible(state, "6.1.24", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["anga_kind"]             = "6.1.24"
    return state
