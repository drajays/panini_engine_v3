"""
6.1.12  दाश्वान् साह्वान् मीढ्वांश्च  —  VIDHI
...
_GATE_KEY: str = "6_1_12_dASvAn_12"


def cond(state: State) -> bool:
    return samhita_gate_eligible(state, "6.1.12", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["anga_kind"]             = "6.1.12"
    return state
