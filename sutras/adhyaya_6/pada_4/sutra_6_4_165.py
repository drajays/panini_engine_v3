"""
6.4.165  गाथिविदथिकेशिगणिपणिनश्च  —  VIDHI
...
_GATE_KEY: str = "6_4_165_gATividaTi_165"


def cond(state: State) -> bool:
    return samhita_gate_eligible(state, "6.4.165", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["anga_kind"]             = "6.4.165"
    return state
