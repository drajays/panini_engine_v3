"""
6.4.47  भ्रस्जो रोपधयोः रमन्यतरस्याम्  —  VIDHI
...
_GATE_KEY: str = "6_4_47_Brasjo_47"


def cond(state: State) -> bool:
    return samhita_gate_eligible(state, "6.4.47", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["anga_kind"]             = "6.4.47"
    return state
