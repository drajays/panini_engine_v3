"""
6.4.45  सनः क्तिचि लोपश्चास्यान्यतरस्याम्  —  VIDHI
...
_GATE_KEY: str = "6_4_45_sanaH_45"


def cond(state: State) -> bool:
    return samhita_gate_eligible(state, "6.4.45", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["anga_kind"]             = "6.4.45"
    return state
