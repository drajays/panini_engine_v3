"""
6.2.31  दिष्टिवितस्त्योश्च  —  VIDHI
...
_GATE_KEY: str = "6_2_31_dizwivitas_31"


def cond(state: State) -> bool:
    return samhita_gate_eligible(state, "6.2.31", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["anga_kind"]             = "6.2.31"
    return state
