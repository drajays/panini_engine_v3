"""
6.2.160  कृत्योकेष्णुच्चार्वादयश्च  —  VIDHI
...
_GATE_KEY: str = "6_2_160_kftyokezRu_160"


def cond(state: State) -> bool:
    return samhita_gate_eligible(state, "6.2.160", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["anga_kind"]             = "6.2.160"
    return state
