"""
6.2.148  कारकाद्दत्तश्रुतयोरेवाशिषि  —  VIDHI
...
_GATE_KEY: str = "6_2_148_kArakAddat_148"


def cond(state: State) -> bool:
    return samhita_gate_eligible(state, "6.2.148", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["anga_kind"]             = "6.2.148"
    return state
