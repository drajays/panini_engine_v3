"""
8.3.88  सुविनिर्दुर्भ्यः सुपिसूतिसमाः  —  VIDHI
...
_GATE_KEY: str = "8_3_88_suvinirdur_88"


def cond(state: State) -> bool:
    return tripadi_gate_eligible(state, "8.3.88", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["sandhi_kind"]             = "8.3.88"
    return state
