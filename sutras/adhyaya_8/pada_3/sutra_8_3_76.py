"""
8.3.76  स्फुरतिस्फुलत्योर्निर्निविभ्यः  —  VIDHI
...
_GATE_KEY: str = "8_3_76_sPuratisPu_76"


def cond(state: State) -> bool:
    return tripadi_gate_eligible(state, "8.3.76", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["sandhi_kind"]             = "8.3.76"
    return state
