"""
8.4.61  उदः स्थास्तम्भोः पूर्वस्य  —  VIDHI
...
_GATE_KEY: str = "8_4_61_udaH_61"


def cond(state: State) -> bool:
    return tripadi_gate_eligible(state, "8.4.61", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["sandhi_kind"]             = "8.4.61"
    return state
