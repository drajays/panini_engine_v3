...
_GATE_KEY: str = "3_1_145_Silpini_145"


def cond(state: State) -> bool:
    if not krt_insertion_eligible(state, "3.1.145", gate_key=_GATE_KEY, adhikara_id="3.1.1"):
        return False
    return not any(
