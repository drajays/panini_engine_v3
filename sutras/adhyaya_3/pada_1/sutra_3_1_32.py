...
def act(state: State) -> State:
    for t in state.terms:
        if "sanadi" in t.tags:
            t.tags.add("dhatu")
            t.tags.add("anga")
        elif t.kind == "prakriti" and "prātipadika" in t.tags:
            # ṇic/curādi: the sanādi Term is separate; the prakriti also
            # becomes dhātu so downstream saṃjñā rules see a unified dhātu.
            t.tags.add("dhatu")
            t.tags.add("anga")
