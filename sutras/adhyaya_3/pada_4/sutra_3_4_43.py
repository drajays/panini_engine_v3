"""
3.4.43  कर्त्रोर्जीवपुरुषयोर्नशिवहोः  —  VIDHI
...
_GATE_KEY: str = "3_4_43_kartrorjIv_43"


def cond(state: State) -> bool:
    return tin_pratyaya_gate_eligible(state, "3.4.43", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["krt_kind"] = "3.4.43"
    return state
