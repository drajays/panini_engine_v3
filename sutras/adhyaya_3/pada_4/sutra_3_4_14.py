"""
3.4.14  कृत्यार्थे तवैकेन्केन्यत्वनः  —  VIDHI
...
_GATE_KEY: str = "3_4_14_kftyArTe_14"


def cond(state: State) -> bool:
    return tin_pratyaya_gate_eligible(state, "3.4.14", gate_key=_GATE_KEY)


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["krt_kind"] = "3.4.14"
    return state
