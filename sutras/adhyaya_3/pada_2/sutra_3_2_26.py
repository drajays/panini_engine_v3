"""
3.2.26  फलेग्रहिरात्मम्भरिश्च  —  VIDHI
...
_GATE_KEY: str = "3_2_26_Palegrahir_26"


def cond(state: State) -> bool:
    return krt_insertion_eligible(state, "3.2.26", gate_key=_GATE_KEY, adhikara_id="3.1.1")


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["krt_kind"] = "3.2.26"
    return state
