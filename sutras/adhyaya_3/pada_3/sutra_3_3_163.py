"""
3.3.163  प्रैषातिसर्गप्राप्तकालेषु कृत्याश्च  —  VIDHI
...
_GATE_KEY: str = "3_3_163_prEzAtisar_163"


def cond(state: State) -> bool:
    return krt_insertion_eligible(state, "3.3.163", gate_key=_GATE_KEY, adhikara_id="3.1.1")


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["krt_kind"] = "3.3.163"
    return state
