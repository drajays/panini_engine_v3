"""
4.1.150  फाण्टाहृतिमिमताभ्यां णफिञौ  —  VIDHI
...
_GATE_KEY: str = "4_1_150_PARwAhftim_150"


def cond(state: State) -> bool:
    if state.paribhasha_gates.get(_GATE_KEY) is True:
        return False
    if not adhikara_in_effect("4.1.150", state, "4.1.92"):
        return False
...
def act(state: State) -> State:
    ...
    state.meta["taddhita_kind"]             = "4.1.150"
    return state
