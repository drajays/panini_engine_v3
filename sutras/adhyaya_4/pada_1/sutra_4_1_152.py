"""
4.1.152  सेनान्तलक्षणकारिभ्यश्च  —  VIDHI
...
_GATE_KEY: str = "4_1_152_senAntalak_152"


def cond(state: State) -> bool:
    if state.paribhasha_gates.get(_GATE_KEY) is True:
        return False
    if not adhikara_in_effect("4.1.152", state, "4.1.92"):
        return False
...
def act(state: State) -> State:
    ...
    state.meta["taddhita_kind"]             = "4.1.152"
    return state
