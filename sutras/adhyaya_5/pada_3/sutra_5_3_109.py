"""
5.3.109  एकशालायाष्ठजन्यतरस्याम्  —  VIDHI
...
_GATE_KEY: str = "5_3_109_ekaSAlAyAz_109"


def cond(state: State) -> bool:
    if state.paribhasha_gates.get(_GATE_KEY) is True:
        return False
    if not adhikara_in_effect("5.3.109", state, "5.1.1"):
        return False
...
def act(state: State) -> State:
    ...
    state.meta["taddhita_kind"]             = "5.3.109"
    return state
