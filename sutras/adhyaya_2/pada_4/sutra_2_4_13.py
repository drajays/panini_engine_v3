"""
2.4.13  विप्रतिषिद्धं चानधिकरणवाचि  —  VIDHI
...
_GATE_KEY: str = "2_4_13_vipratisiddha_anadhik"


def cond(state: State) -> bool:
    if state.paribhasha_gates.get(_GATE_KEY) is True:
        return False
    return state.meta.get("2_4_13_arm") is True


def act(state: State) -> State:
    state.paribhasha_gates[_GATE_KEY] = True
    state.samjna_registry[_GATE_KEY]  = True
    state.meta["dvandva_kind"]             = "2.4.13"
    return state
