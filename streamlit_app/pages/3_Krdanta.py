...
st.markdown(
    ...
    "ट्रेस में प्रत्येक चरण पर **पूर्व/पश्चात्** दोनों लिपियों में: **SLP1** + **देवनागरी**, "
    "तथा **हिन्दी सहायक**।"
)
...
with tab_nvul:
    ...
    if run_nvul:
        ...
        st.markdown(
            f"**प्रातिपदिक:** {format_slp1_deva_pair(surface_slp)}"
        )
...
with tab_trc:
    ...
    if run_trc:
        ...
        st.markdown("#### निष्कर्ष")
        st.markdown(
            f"**तृच्-मूल:** {format_slp1_deva_pair(stem_slp)}\n\n"
            f"**पद (प्रथमा एकवचन):** {format_slp1_deva_pair(final_slp)}"
        )
